...
class APPBase(ABC):
    def __init__(self, blockList:List[str], unblockList:List[str], filterDict:Dict[str,str], filterList:List[str], filterList_var:List[str], ChinaSet:Set[str], fileName:str, sourceRule:str):
        self.homepage:str = "https://github.com/moshanghuakai001/adblockfilters"
        self.source:str = "https://raw.githubusercontent.com/moshanghuakai001/adblockfilters/main/rules"
